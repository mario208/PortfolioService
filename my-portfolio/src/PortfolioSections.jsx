...
const PortfolioSections = () => {
    ...
    const portfolioItems = [
        { title: 'Fintech Dashboard', category: 'Dentist', img: '/api/placeholder/600/400' },
        { title: 'E-Commerce Platform', category: 'Real Estate', img: '/api/placeholder/600/400' },
        { title: 'Cyberpunk Brand Concept', category: 'Food Industry', img: '/api/placeholder/600/400' },
        { title: 'SaaS Analytics Tool', category: 'Dentist', img: '/api/placeholder/600/400' },
        { title: 'Crypto Wallet App', category: 'Real Estate', img: '/api/placeholder/600/400' },
        { title: 'Minimalist Studio Identity', category: 'Food Industry', img: '/api/placeholder/600/400' }
    ];
